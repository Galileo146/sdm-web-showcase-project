        ...
        <div className="flex flex-col md:flex-row mb-16">
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              Con oltre 20 anni di esperienza nel settore, ci impegniamo costantemente a migliorare i nostri 
              processi e a investire nelle tecnologie più avanzate per mantenere la nostra posizione di leader nel mercato.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-8 lg:mb-0 flex justify-center">
            <div className="relative">
              <img 
                src="/lovable-uploads/ba1d52b8-220a-48ce-812c-40e0bdbe4ca6.png" 
                alt="Mappa Europa SDM Group" 
          ...
          <div className="lg:w-1/2">
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <div 
                  key={index} 
                  className="bg-gray-100 p-6 rounded-lg shadow-sm transition-all duration-300 hover:shadow-md"
                >
