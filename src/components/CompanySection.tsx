...
const CompanySection = () => {
  ...
  return <section className="py-16 bg-neutral-50">
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {companies.map(company => <CompanyBox key={company.name} image={company.image} logo={company.logo} name={company.name} link={company.link} />)}
        </div>
      </div>
    </section>;
};
