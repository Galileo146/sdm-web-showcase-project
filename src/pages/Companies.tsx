...
const Companies = () => {
  ...
  const companies = [{
    ...
    images: ["/lovable-uploads/e0e7d03a-71c6-4e47-aa98-4559b1c0c68d.png",
    // Elicottero
    "/lovable-uploads/4a711b9a-b8b3-464e-b98b-59c1ba979ffc.png",
    // Area 1 e 2
    "/lovable-uploads/b064a197-d842-4067-bc40-a05ff9f4409d.png",
    // Corridoio stabilimento
    "/lovable-uploads/e64e62ba-034b-4fa5-a3a5-5ce97ec8cbc5.png",
    // Area stabilimento
    "/lovable-uploads/7058536d-2aef-48f4-a986-cc9e1d68e2b4.png",
    // Logo SDM sul muro
    ...
    images: ["https://via.placeholder.com/600x400?text=SDM+Rivoli+1", "https://via.placeholder.com/600x400?text=SDM+Rivoli+2", "https://via.placeholder.com/600x400?text=SDM+Rivoli+3", "https://via.placeholder.com/600x400?text=SDM+Rivoli+4", "https://via.placeholder.com/600x400?text=SDM+Rivoli+5"]
  }, {
    id: 3,
    name: "SDM POLSKA",
    ...
    images: ["https://via.placeholder.com/600x400?text=SDM+Polska+1", "https://via.placeholder.com/600x400?text=SDM+Polska+2", "https://via.placeholder.com/600x400?text=SDM+Polska+3", "https://via.placeholder.com/600x400?text=SDM+Polska+4", "https://via.placeholder.com/600x400?text=SDM+Polska+5"]
  }, {
    id: 4,
    name: "CHIALES TOOLS",
    ...
    images: ["https://via.placeholder.com/600x400?text=Chiales+Tools+1", "https://via.placeholder.com/600x400?text=Chiales+Tools+2", "https://via.placeholder.com/600x400?text=Chiales+Tools+3", "https://via.placeholder.com/600x400?text=Chiales+Tools+4", "https://via.placeholder.com/600x400?text=Chiales+Tools+5"]
  }];
  return <div>
      {/* 1. Hero Section */}
      <Hero backgroundImage="/lovable-uploads/083c20b6-609c-4ff3-906d-782248fabf1a.png" title="LE AZIENDE" height="450px" centerTitle={false} />
      ...
      <section className="py-8 md:py-16 bg-gray-100">
        <div className="container-wide">
          {companies.map((company, index) => <CompanyCard key={company.id} company={company} reversed={index % 2 !== 0} index={index + 1} />)}
        </div>
      </section>
